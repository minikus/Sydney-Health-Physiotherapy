...
"Add an icon",
"Select icon",
"Select icon that you want to insert.",
"Select icon size",
"Huge",
"Small icons are used in regular text, while big icons are centered and have hover effect.",
"Select color",
"Colored",
"Choose between two predefined color modes. Only works on small icons.",
"Enter the button text here",
"Open in new window",
"Should the url be opened in new window or not.",
"Select optional icon displayed inside button.",
...
"Footer Title",
"Displayed only in case transparent footer is used",
"Copyright",
"This is the footer copyright message.",
"Footer type",
"Choose between two different footer display types.",
"Transparent",
"Projects Intro gallery",
"Select a gallery displayed at the top of every project. This option can be altered on a per-project basis.",
"Don't use gallery",
"Home Settings",
"Home Page Type",
"Choose a homepage type you need. This refers to the top splash area.",
"Home Page Size",
"Select between fullscreen or fixed size. Video homepage is not compatible with the fixed size.",
"Image background",
"Used as a background of the landing page.",
"Slider Gallery",
"Select a gallery used for a landing page.",
"Gallery look",
"Select between two different landing page looks. First one is simple and supports logo and services but will maintain a single caption on all slides, second one has different captions for each slide.",
"Simple",
"Multiple captions",
"Mobile fallback",
"Simple slider supports fallback image on mobile browsers which can have issues with this type of slider. If left empty, slider wil be used on mobile too.",
"Show controls",
"If set to yes, gallery controls will be shown and autoplay will be disabled. Bullets are only supported on Services & Logo slider.",
"Arrows",
"Bullets",
"Both",
"Landing Title",
...
"Landing look",
"Select between two different landing page looks. First one is more simplistic, second one supports logo and services.",
"Services & logo",
"Used on the landing page.",
"Add one or more service.",
"Use video?",
"Choose if you would like to display video or not.",
"Select a video used for a landing page. Only YouTube vidoes supported.",
"Autoplay Video",
"Should video play automatically.",
"Loop Video",
"Should video loop.",
"Mute Video",
"Should video be silenced by default.",
"Video Start label",
"Leave empty to use only icon.",
"Hide content on play",
"Should content disappear when video starts playing.",
"Background color",
"When set to \"yes\", section background becomes transparent (color setting is ignored in this case).",
"Intro settings",
"Introduction text",
"Displayed above the page content.",
"Text displayed above services in services carousel.",
"Display type",
"Choose between carousel and columns display",
"Select Project to display",
"Select project that will be featured.",
"Display only top",
"If set to yes, only top slider gallery (if set) and project content will be displayed.",
"Author Section",
"Featured heading",
"Bold text displayed on top of the featured image.",
"Featured description",
"Italic description text displayed on top of the featured image, below the heading.",
"Avatar",
"Author avatar displayed between featured image and content.",
"Intro title",
"Title displayed above intro text.",
"Intro text",
"Text displayed in larger font above content, good for a short intro.",
"Staff Section",
"Staff members",
"Select Staff members to display",
"Quotes",
"Add one or more quotes to the slider.",
"Add Quote",
"Contact Options",
"Contact Info.",
"Global",
"Open in lightbox",
"Should this project be opened in lightbox when displayed in project page.",
"Displayed above content in big font.",
"Project Intro gallery",
"Select a gallery displayed at the top of this project. Default is Global, which is set in Theme Options panel.",
"Displayed below the project, useful for grabbing attention.",
"Text displayed above features in services carousel.",
"Service icon",
"Select icon that will be assigned to this service. For icons overview, Google \"Font Awesome\".",
"Link is used on multiple places, depending on the service location. Use to link single service to certain url.",
"Link Text",
"Link text is used when service link is displayed in button form or link below service.",
"Category: %s",
"Tag: %s",
"The Blog",
"Search..",
